...
// ==========================================
const KEY_GAMES = 'nexustopup_games';
const KEY_TRANSACTIONS = 'nexustopup_transactions';
const KEY_VOUCHERS = 'nexustopup_vouchers';
...
const DEFAULT_GAMES = [
  ...
  },
  {
    ...
    category: 'PC',
    image: 'https://images.unsplash.com/photo-1547082299-de196ea013d6?q=80&w=300&auto=format&fit=crop',
    gradient: 'linear-gradient(135deg, #4c1d95, #8b5cf6)',
    placeholderId: 'UID (Server) | Contoh: 812345678 (Asia)',
    description: 'Beli Welkin Moon atau Genesis Crystals Genshin Impact legal, murah, dan aman.',
    packages: [
...
const DEFAULT_VOUCHERS = [
  ...
  { code: 'UAS2026', type: 'percentage', value: 20, maxDiscount: 20000, description: 'Promo Spesial UAS Web Prog - Diskon 20% (Maks Rp20.000)' },
